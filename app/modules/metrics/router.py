...
from app.modules.metrics.schemas import MetricsSummary
from app.modules.metrics.service import MetricsService

router = APIRouter(prefix="/metrics", tags=["Metrics"])
metrics_service = MetricsService()

@router.get("/summary", response_model=MetricsSummary, dependencies=[Depends(RoleGuard(UserRole.OWNER, UserRole.ADMIN, UserRole.STAFF))])
